                                ...
                                <div class="joomdev-wss-options-box-options-single-option">
                                    ...
                                    <div class="joomdev-wss-options-box-sided second-cell">
                                        <section class="joomdev-wss-singleselect-animation">
                                            ...
                                            <span class="joomdev-wss-url_shorting-box url_shorting_bit_ly" style="display:block;">
                                            ...
                                            <span class="joomdev-wss-url_shorting-box url_shorting_goo_gl" style="display:none;">
                                                <div class="joomdev-form-field">
                                                    <label>
                                                        <span>API Key</span>
                                    ...
                                    <div class="joomdev-wss-options-box-sided second-cell">
                                        <div class="joomdev-form-field">
                                            <label>
                                                ...
                                                <input type="text" placeholder="Twitter Habdler" name="joomdev_wss_options[twitter_handler]" value="<?php echo $joomdev_wss_options['twitter_handler']; ?>">
                                            </label>
                                        </div>
                                    </div>
                                </div>
